    ...
    return (
        <div className="mt-10 w-11/12 max-w-3xl lg:max-w-5xl xl:max-w-6xl mx-auto bg-gray-50">
            ...
            <div className="mt-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-4">
                <div className="flex">
                    <img className="h-36 w-48 sm:w-56 object-cover rounded-md" src="/Delhi.jpg"/>
                    <div className="flex flex-col justify-center px-2 lg:px-5">
                        <h1 className="lg:text-xl text-gray-800 font-bold">Delhi NCR</h1>
                        <p>50 spaces</p>
                    </div>
                </div>
                <div className="flex">
                    <img className="h-36 w-48 sm:w-56 object-cover rounded-md" src="/Bangalore.jpg"/>
                    <div className="flex flex-col justify-center px-2 lg:px-5">
                ...
                <div className="flex">
                    <img className="h-36 w-48 sm:w-56 object-cover rounded-md" src="/Hyderabad.jpg"/>
                    <div className="flex flex-col justify-center px-2 lg:px-5">
                ...
                <div className="flex">
                    <img className="h-36 w-48 sm:w-56 object-cover rounded-md" src="/Pune.jpg"/>
                    <div className="flex flex-col justify-center px-2 lg:px-5">
                ...
                <div className="flex">
                    <img className="h-36 w-48 sm:w-56 object-cover rounded-md" src="/Mumbai.jpg"/>
                    <div className="flex flex-col justify-center px-2 lg:px-5">
                ...
                <div className="flex">
                    <img className="h-36 w-48 sm:w-56 object-cover rounded-md" src="/Lucknow.jpg"/>
                    <div className="flex flex-col justify-center px-2 lg:px-5">
